...
const SchoolCoreContext = createContext<{ state: SchoolCoreState, dispatch: Dispatch<Action> }>({ state: initialState, dispatch: () => {} });
...
export const SchoolCoreProvider = ({ children }: { children: ReactNode }) => {
    ...
    return <SchoolCoreContext.Provider value={{ state, dispatch }}>{children}</SchoolCoreContext.Provider>
